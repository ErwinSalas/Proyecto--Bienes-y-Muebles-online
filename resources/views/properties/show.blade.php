    ...
    <div class="rs_menu">
        <div class="rs_menu_inner_section">
            <div class="rs_menu_pic">
                <img src="images/menubg.jpg" class="img-responsive" alt="">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="rs_topheader_left">
                ...
                <div class="rs_search">
                    <form>
                        <input type="text" class="rs_search_input" placeholder="Mockup, banner, icons, fonts......">
                    </form>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="page_title">
                    <h3 class="rs_bottompadder20">Products Details Page - Comments</h3>
                </div>
            </div>
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <ul class="breadcrumb">
            ...
            <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                <div class="rs_single_product_slider">
                    <ul class="pgwSlideshow">
                        <li><img src="images/slider/pro_s1.jpg" alt=""></li>
                        <li><img src="images/slider/pro_s1.jpg" alt=""></li>
                        <li><img src="images/slider/pro_s1.jpg" alt=""></li>
                        <li><img src="images/slider/pro_s1.jpg" alt=""></li>
                        <li><img src="images/slider/pro_s1.jpg" alt=""></li>
                ...
                <div class="rs_buy_license_section">
                    ...
                    <img src="images/product/sp_sells.jpg" alt="">
                    <h4>Key Features:</h4>
                    <ul>
                        <li>Dark & Light Version</li>
                        <li>Boxed & Fullwidth Version</li>
                        <li>HTML5 & CSS3 Technology</li>
                        <li>20+ Onepage Designs</li>
                        <li>20+ Multipage Designs</li>
                        <li>Different Header Layout Styles</li>
                        <li>Different Footer Layout Styles</li>
                        <li>Mega Menu Support</li>
                        <li>Revolution Slider ($14 value)</li>
                        <li>Twitter Bootstrap 3.1</li>
                        <li>124+ Valid HTML5 Page Templates</li>
                        <li>5+ Blog Styles</li>
                        <li>20+ Portfolio Styles</li>
                        <li>Custom Member Pages</li>
                        <li>Custom Contact Pages</li>

                        <li>Custom About Pages</li>
                        <li>Custom Services Pages</li>
                        <li>100% Responsive Layout Design</li>
                        <li>Retina Display Ready</li>
                        <li>Amazing jQuery Effects and Script</li>
                        <li>Professional Shortcode Elements</li>
                        <li>Awesome Animations</li>
                        <li>Social Media Friendly</li>
                        <li>Search Engine Optimization</li>
                        <li>Google Fonts Usable</li>
                        <li>Awesome Font Icons Included</li>
                        <li>Elegant Font Icons Included</li>
                        <li>Detailed Documentation</li>
                        <li>24/7 Ask Questions via Email, Twitter</li>
                        <li>and much more…</li>
                    </ul>
                    <div class="rs_social">
                        <ul>
                                ...
                                <div class="rs_author_comments_show">
                                        ...
                                        <li>
                                            <div class="rs_commentdiv">
                                                <div class="rs_comment_img">
                                                    <img src="images/blog/bloger_1.jpg" class="img-responsive" alt="">
                                                </div>
                                            ...
                                            <ol>
                                                <li>
                                                    <div class="rs_commentdiv">
                                                        <div class="rs_comment_img">
                                                            <img src="images/blog/bloger_2.jpg" class="img-responsive" alt="">
                                                        </div>
                                                        <div class="rs_comment_data">
                                                            <h5>DigitalGravy <kbd>author</kbd></h5>
                                                            <a href="#"><i class="fa fa-flag"></i> report</a>
                                                            <span>19 Nov 2015</span>
                                                            <p>We work with clients big and small across a range of sectors and we utilise all forms of media to get your name out there in a way that’s right for you.</p>
                                                        </div>
                                                    </div>
                                                </li>
                                                <li>
                                                        ...
                                                        <div class="rs_comment_data">
                                                            <form>
                                                                ...
                                                                <div class="rs_reply_checkbox">
                                                                    <div class="rs_checkbox"><input type="checkbox" value="1" id="check2" name="checkbox">
                                                                        <label for="check2"></label></div> <span>Receive email notification for this comments reply </span>
                                                                    <div class="rs_btn_div">
                                    ...
                                    <ol class="comment">
                                        <li>
                                            <div class="rs_commentdiv">
                                                <div class="rs_comment_img">
                                                    <img src="images/blog/bloger_3.jpg" class="img-responsive" alt="">
                                                </div>
                                                <div class="rs_comment_data">
                                                    <h5>Christiana Randy</h5>
                                                    <a href="#"><i class="fa fa-flag"></i> report</a>
                                                    <span>19 Nov 2015</span>
                                                    <p>We work with clients big and small across a range of sectors and we utilise all forms of media to get your name out there in a way that’s right for you.</p>
                                                </div>
                                        ...
                                        <li>
                                            <div class="rs_commentdiv">
                                                <div class="rs_comment_img">
                                                    <img src="images/blog/bloger_4.jpg" class="img-responsive" alt="">
                                                </div>
                                                <div class="rs_comment_data">
                                                    <h5>Jonathan Clark (Author view Point)</h5>
                                                    <a href="#"><i class="fa fa-flag"></i> report</a>
                                                    <span>19 Nov 2015</span>
                                                    <p>We have a number of different teams within our agency that specialise in different areas of business so you can be sure that you won’t receive a generic service and although</p>
                                                </div>
                                            </div>
                                            <ol>
                                                <li class="rs_reply_box">
                                            ...
                                            <div class="rs_commentdiv">
                                                ...
                                                <div class="rs_comment_data">
                                                    <form>
                                                        ...
                                                        <div class="rs_reply_checkbox">
                                                            <div class="rs_checkbox"><input type="checkbox" value="1" id="check3" name="checkbox">
                                                                <label for="check3"></label></div> <span>Receive email notification for this comments reply </span>
                                                            <div class="rs_btn_div">
                                                                <a href="#" class="rs_button rs_button_orange">Post Comment</a>
                                                            </div>
                                                        </div>
                                                    </form>
                                                </div>
                    ...
                    <aside class="widget widget_product">
                        ...
                        <div class="rs_product_div">
                            <div class="rs_product_img">
                                <img src="images/product/product7.jpg" class="img-responsive" alt="">
                            ...
                            <div class="rs_product_div_footer">
                                <div class="rs_author_div">
                                    <img src="images/author7.jpg" class="img-responsive" alt="">
                                    <div>
                        ...
                        <div class="rs_product_div">
                            <div class="rs_product_img">
                                <img src="images/product/product10.jpg" class="img-responsive" alt="">
                                <div class="rs_overlay">
                                    <div class="rs_overlay_inner">
                                        <ul>
                ...
                <div id="owl-demo" class="owl-carousel owl-theme">
                    <div class="item">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="rs_product_div">
                                <div class="rs_product_img">
                                    <img src="images/product/product4.jpg" class="img-responsive" alt="">
                                    <div class="rs_overlay">
                                        <div class="rs_overlay_inner">
                                            <ul>
                                                <li><a class="fancybox animated slideInDown" data-fancybox-group="product" href="images/product/product_big4.jpg" title="Vertical WP Theme"><i class="fa fa-eye"></i></a></li>
                                                <li><a href="#" class="animated slideInDown"><i class="fa fa-shopping-cart"></i></a></li>
                                            </ul>
                                        </div>
                                    </div>
                                ...
                                <div class="rs_product_div_footer">
                                    <div class="rs_author_div">
                                        <img src="images/author4.jpg" class="img-responsive" alt="">
                                        <div>
                    ...
                    <div class="item">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="rs_product_div">
                                <div class="rs_product_img">
                                    <img src="images/product/product5.jpg" class="img-responsive" alt="">
                                    <div class="rs_overlay">
                                        <div class="rs_overlay_inner">
                                            <ul>
                                                <li><a class="fancybox animated slideInDown" data-fancybox-group="product" href="images/product/product_big5.jpg" title="20 Device Mock-up"><i class="fa fa-eye"></i></a></li>
                                                <li><a href="#" class="animated slideInDown"><i class="fa fa-shopping-cart"></i></a></li>
                                            </ul>
                                        </div>
                                    </div>
                                ...
                                <div class="rs_product_div_footer">
                                    <div class="rs_author_div">
                                        <img src="images/author5.jpg" class="img-responsive" alt="">
                                        <div>
                    ...
                    <div class="item">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="rs_product_div">
                                ...
                                <div class="rs_product_img">
                                    <img src="images/product/product6.jpg" class="img-responsive" alt="">
                                    <div class="rs_overlay">
                                        <div class="rs_overlay_inner">
                                            <ul>
                                                <li><a class="fancybox animated slideInDown" data-fancybox-group="product" href="images/product/product_big6.jpg" title="2PX Line Icons Set"><i class="fa fa-eye"></i></a></li>
                                                <li><a href="#" class="animated slideInDown"><i class="fa fa-shopping-cart"></i></a></li>
                                            </ul>
                                        </div>
                                    </div>
                                ...
                                <div class="rs_product_div_footer">
                                    <div class="rs_author_div">
                                        <img src="images/author6.jpg" class="img-responsive" alt="">
                                        <div>
                    ...
                    <div class="item">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="rs_product_div">
                                <div class="rs_product_img">
                                    <img src="images/product/product8.jpg" class="img-responsive" alt="">
                                    <div class="rs_overlay">
                                        <div class="rs_overlay_inner">
                                            <ul>
                                                <li><a class="fancybox animated slideInDown" data-fancybox-group="product" href="images/product/product_big8.jpg" title="20 Fancy Hero Images"><i class="fa fa-eye"></i></a></li>
                                                <li><a href="#" class="animated slideInDown"><i class="fa fa-shopping-cart"></i></a></li>
                                            </ul>
                                        </div>
                                    </div>
                                ...
                                <div class="rs_product_div_footer">
                                    <div class="rs_author_div">
                                        <img src="images/author8.jpg" class="img-responsive" alt="">
                                        <div>
                                            <h4><a href="author_dashboard.html">Digital Gravy</a></h4>
                                            <p><a href="#">Stock Images</a></p>
                                        </div>
                                    </div>
                                    <div class="rs_share">
                                        <ul>
                    ...
                    <div class="item">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="rs_product_div">
                                <div class="rs_product_img">
                                    <img src="images/product/product9.jpg" class="img-responsive" alt="">
                                    <div class="rs_overlay">
                                        <div class="rs_overlay_inner">
                                            <ul>
                                                <li><a class="fancybox animated slideInDown" data-fancybox-group="product" href="images/product/product_big9.jpg" title="Minimal HTML5 Template"><i class="fa fa-eye"></i></a></li>
                                                <li><a href="#" class="animated slideInDown"><i class="fa fa-shopping-cart"></i></a></li>
                                            </ul>
                                        </div>
                                    </div>
                                ...
                                <div class="rs_product_div_footer">
                                    <div class="rs_author_div">
                                        <img src="images/author9.jpg" class="img-responsive" alt="">
                                        <div>
                                            <h4><a href="author_dashboard.html">Rob Brown</a></h4>
                                            <p><a href="#">HTML Templates</a></p>
                                        </div>
                                    </div>
                                    <div class="rs_share">
                    ...
                    <div class="item">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="rs_product_div">
                                <div class="rs_product_img">
                                    <img src="images/product/product11.jpg" class="img-responsive" alt="">
                                    <div class="rs_overlay">
                                        <div class="rs_overlay_inner">
                                            <ul>
                                                <li><a class="fancybox animated slideInDown" data-fancybox-group="product" href="images/product/product_big11.jpg" title="Brand Identity Mock-up Set"><i class="fa fa-eye"></i></a></li>
                                                <li><a href="#" class="animated slideInDown"><i class="fa fa-shopping-cart"></i></a></li>
                                            </ul>
                                        </div>
                                    </div>
                                ...
                                <div class="rs_product_div_footer">
                                    <div class="rs_author_div">
                                        <img src="images/author11.jpg" class="img-responsive" alt="">
                                        <div>
                                            <h4><a href="author_dashboard.html">Brie Larson</a></h4>
                                            <p><a href="#">Mockup</a></p>
                                        </div>
                                    </div>
                                    <div class="rs_share">
                    ...
                    <div class="item">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="rs_product_div">
                                <div class="rs_product_img">
                                    <img src="images/product/product12.jpg" class="img-responsive" alt="">
                                    <div class="rs_overlay">
                                        <div class="rs_overlay_inner">
                                            <ul>
                                                <li><a class="fancybox animated slideInDown" data-fancybox-group="product" href="images/product/product_big12.jpg" title="10 Photoshop Actions"><i class="fa fa-eye"></i></a></li>
                                                <li><a href="#" class="animated slideInDown"><i class="fa fa-shopping-cart"></i></a></li>
                                            </ul>
                                        </div>
                                    </div>
                                ...
                                <div class="rs_product_div_footer">
                                    <div class="rs_author_div">
                                        <img src="images/author12.jpg" class="img-responsive" alt="">
                                        <div>
                                            <h4><a href="author_dashboard.html">Jeremy Luke</a></h4>
                                            <p><a href="#">PSD Actions</a></p>
                                        </div>
                                    </div>
                                    <div class="rs_share">
                                        <ul>
        ...
        <div class="row">
            <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                <div class="rs_footerdiv">
                    ...
                    <p>So you can be sure that you won’t receive a generic service and although we can’t boast years and years of service.</p>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        <div class="rs_footerdiv">
                            ...
                            <ul>
                                <li><a href="#"><i class="fa fa-angle-double-right"> </i>about <i class="fa fa-angle-double-right"> </i></a></li>
                                <li><a href="#"><i class="fa fa-angle-double-right"> </i>Terms <i class="fa fa-angle-double-right"> </i></a></li>
                                <li><a href="#"><i class="fa fa-angle-double-right"> </i>Privacy Policy <i class="fa fa-angle-double-right"> </i></a></li>
                                <li><a href="#"><i class="fa fa-angle-double-right"> </i>Careers <i class="fa fa-angle-double-right"> </i></a></li>
                                <li><a href="#"><i class="fa fa-angle-double-right"> </i>Directory <i class="fa fa-angle-double-right"> </i></a></li>
                                <li><a href="#"><i class="fa fa-angle-double-right"> </i>SimpleLicense <i class="fa fa-angle-double-right"> </i></a></li>
                                <li><a href="#"><i class="fa fa-angle-double-right"> </i>Brand <i class="fa fa-angle-double-right"> </i></a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
